...
import 'package:chat_client_app/features/chat_page/presentation/cubit/chat_subscription_cubit.dart';
...
class _ChatPageState extends State<ChatPage> {
      ...
      body: BlocBuilder<ChatSubscriptionCubit, BaseSocketSubscriptionState>(
              ...
              builder: (BuildContext context, state) {
                if(state is UserConnectedState || widget.action == ThemeAction.select){
                  ...
                  return _buildChatLoadingContent();
                }
              }
            ),
    );
  ...
  Widget _buildChatLoadingContent() => const Center(child: AppProgressIndicator());
  ...
  Widget _buildChatField() => Container(
    height: 50,
